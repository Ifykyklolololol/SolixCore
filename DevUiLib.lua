...
local Library do 
    ...
    if not isfolder(Library.Folders.Configs .. "/" .. GameName) then
        makefolder(Library.Folders.Configs .. "/" .. GameName)
    end
    ...
    Library.RefreshThemeList = function(self, Element)
        ...
        List = listfiles(Library.Folders.Themes)
    ...
    Library.GetFolder = function(self)
        return Library.Folders.Configs .. "/" .. GameName .. "/"
    end 

    Library.GetFolderTheme = function(self)
        return Library.Folders.Themes .. "/"
    end

    Library.CheckForAutoLoad = function(self)
        local ConfigContent = readfile(Library.Folders.Directory .. "/autoload.json")
    ...
    do 
        Library.CreateColorpicker = function(self, Data)
                ...
                if Dropdown.IsOpen then 
                    ...
                    RenderStepped = RunService.RenderStepped:Connect(function()
                        if IsMobile then 
                            ...
                            UDim2New(
                                0,
                                Items["RealDropdown"].Instance.AbsolutePosition.X / Scale,
                                0,
                            ...
                            Items["OptionHolder"].Instance.Size = UDim2.new(
                                Items["RealDropdown"].Instance.Size.X.Scale,
                                Items["RealDropdown"].Instance.Size.X.Offset,
                                0,
                                Dropdown.MaxSize
                            )
                        else
                        ...
                        Items["OptionHolder"].Instance.Size = UDim2New(0, Items["RealDropdown"].Instance.AbsoluteSize.X, 0, 65)
                    end)
            ...
            Library:Connect(UserInputService.InputBegan, function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    if Dropdown.IsOpen and Colorpicker.IsOpen then
            ...
            Items["RealDropdown"]:Connect("Changed", function(Property)
                if Property == "AbsolutePosition" and Dropdown.IsOpen then
                    Dropdown.IsOpen = not Library:IsClipped(Items["OptionHolder"].Instance, Data.Section.Items["Section"].Instance.Parent)
                    Items["OptionHolder"].Instance.Visible = Dropdown.IsOpen
                end
            end)

            Dropdown:Add("Rainbow")
            Dropdown:Add("Breathing")
        ...
        Library.KeybindList = function(self, Name)
            ...
            function KeybindList:Resize()
                ...
                for Index, Value in Items["Content"].Instance:GetChildren() do 
                    ...
                    YSize = YSize + Value.AbsoluteSize.Y + 5
                    XSize = math.max(XSize, Value.AbsoluteSize.X)

                    table.insert(VisibleItems, Value)
                end
                
                if #VisibleItems == 0 then 
                    XSize = Items["Text"].Instance.TextBounds.X + 14
                    YSize = 32

                    Items["KeybindList"]:Tween(nil, {Size = UDim2New(0, XSize, 0, YSize)})
                    return 
                end

                Items["KeybindList"]:Tween(nil, {Size = UDim2New(0, XSize + 30, 0, YSize + 30)})
            end
        ...
        Library.Notification = function(self, Data)
            ...
            local XSize = Items["Title"].Instance.TextBounds.X + 18
            local YSize = Items["Description"].Instance.TextBounds.Y + Items["Title"].Instance.TextBounds.Y + 40

            Items["Duration"].Instance.Position = UDim2New(0, 0, 0, YSize - 25)

            if Items["Description"].Instance.TextBounds.X > XSize then 
                XSize = Items["Description"].Instance.TextBounds.X + 18
            end

            Items["Notification"].Instance.Size = UDim2New(0, 0, 0, YSize)
            ...
            Library:Thread(function()
                ...
                Items["Notification"]:Tween(Info, {Size = UDim2New(0, XSize, 0, YSize)})
                ...
                task.delay(Data.Duration + 0.1, function()
                    ...
                    Items["Notification"]:Tween(Info, {Size = UDim2New(0, 0, 0, YSize)})
                    task.wait(0.5)
            ...
            function Window:Init()
                Library:Connect(Players.PlayerRemoving, function(Player)
                    if Player == LocalPlayer and Library.AutoSave then 
                        ...
                        writefile(Library.Folders.Directory .. "/autoload.json", Library:GetConfig())
                    end
                end)
            end
            ...
            Library:Connect(Items["Input"].Instance:GetPropertyChangedSignal("Text"), function()
                ...
                for Index, Value in PageSearchData do 
                    ...
                    if StringFind(StringLower(Name), StringLower(Items["Input"].Instance.Text)) then
                        ...
                        if Value.Type and Value.Type == "Button" then
                            Value.Element2.Instance.Visible = false
                        end
                    ...
                    AdButton:Connect("MouseButton1Down", function()
                        if Link and Link ~= "" then
                            if setclipboard then
                                ...
                                Library:Notify({
                                    Name = "Link Copied",
                                    Text = "Advertisement link copied to clipboard!",
                                    Duration = 2
                                })
                            else
                                Library:Notify({
        ...
        Library.Page = function(self, Data)
            ...
            function Page:Turn(Bool)
                ...
                if Page.Active then
                    ...
                    Items["Liner"]:Tween(nil, {Size = UDim2New(0, 6, 1, -20), BackgroundTransparency = 0})

                    Library.CurrentPage = Page
                else
                    Items["Inactive"]:Tween(nil, {BackgroundTransparency = 1})
                    Items["Text"]:Tween(nil, {TextTransparency = 0.4, Position = UDim2New(0, 4, 0.5, 0)})
                    Items["Liner"]:Tween(nil, {Size = UDim2New(0, 6, 0, 0), BackgroundTransparency = 1})
                end
        ...
        Library.Sections.Toggle = function(self, Data)
            ...
            local Toggle = {
                ...
                Description = Data.Description or Data.Description or "Toggle description",
        ...
        Library.Sections.Checkbox = function(self, Data) -- Same code as toggles
            Data = Data or { }
            ...
            local Toggle = {
                ...
                Description = Data.Description or Data.Description or "Checkbox description",
                Flag = Data.Flag or Data.flag or Library:NextFlag(),
                Default = Data.Default or Data.default or false,
                Tooltip = Data.Tooltip or Data.tooltip or nil,
                Callback = Data.Callback or Data.callback or function() end,
        ...
        Library.Sections.Slider = function(self, Data)
            ...
            local Slider = {
                ...
                Description = Data.Description or Data.Description or "Slider description",
                Flag = Data.Flag or Data.flag or Library:NextFlag(),
            ...
            local Items = { } do 
                Items["Slider"] = Instances:Create("Frame", {
                    ...
                    Name = "\0",
                    BackgroundTransparency = 1,
                    Size = UDim2New(1, 0, 0, Slider.Description ~= "" and 62 or 40),
                    BorderColor3 = FromRGB(0, 0, 0),
                    ZIndex = 2,
                    BorderSizePixel = 0
                })
        ...
        Library.Sections.Dropdown = function(self, Data)
            ...
            local Dropdown = {
                ...
                Description = Data.Description or Data.Description or "Dropdown description",
                Flag = Data.Flag or Data.flag or Library:NextFlag(),
            ...
            local Items = { } do 
                Items["Dropdown"] = Instances:Create("Frame", {
                    ...
                    Name = "\0",
                    BackgroundTransparency = 1,
                    Size = UDim2New(1, 0, 0, Dropdown.Description ~= "" and 72 or 50),
                    BorderColor3 = FromRGB(0, 0, 0),
                    ZIndex = 2,
                    BorderSizePixel = 0
                })                
            ...
            function Dropdown:SetOpen(Bool)
                ...
                if Dropdown.IsOpen then 
                    ...
                    RenderStepped = RunService.RenderStepped:Connect(function()
                        if IsMobile then 
                            Items["OptionHolder"].Instance.Position = -- poetry
                            UDim2New(
                                0,
                                Items["RealDropdown"].Instance.AbsolutePosition.X / Scale,
                                0,
            ...
            function Dropdown:Set(Option)
                ...
                if Dropdown.Multi then 
                    ...
                    -- Convert Option to string for lookup and validation
        ...
        Library.Sections.Label = function(self, Name, Description, Tooltip)
            ...
            local Items = { } do 
                Items["Label"] = Instances:Create("Frame", {
                    ...
                    Name = "\0",
                    BackgroundTransparency = 1,
                    Size = UDim2New(1, 0, 0, Label.Description ~= "" and 40 or 20),
                    BorderColor3 = FromRGB(0, 0, 0),
                    ZIndex = 2,
                    BorderSizePixel = 0
                })
        ...
        Library.Sections.Textbox = function(self, Data)
            ...
            local Textbox = {
                ...
                Description = Data.Description or Data.Description or "Textbox description",
                Flag = Data.Flag or Data.flag or Library:NextFlag(),
            ...
            local Items = { } do 
                Items["Textbox"] = Instances:Create("Frame", {
                    ...
                    Name = "\0",
                    BackgroundTransparency = 1,
                    Size = UDim2New(1, 0, 0, Textbox.Description ~= "" and 72 or 50),
                    BorderColor3 = FromRGB(0, 0, 0),
                    ZIndex = 2,
                    BorderSizePixel = 0
                })
    ...
    Library.CreateSettingsPage = function(self, Window, Watermark, KeybindList)
        ...
        do
            ...
            do
                ...
                ConfigsSection:Button():Add("Create", function()
                    if ConfigName then 
                        if ConfigName == "" then 
                            return
                        end

                        writefile(Library:GetFolder().. ConfigName .. ".json", Library:GetConfig())
                        Library:RefreshConfigsList(ConfigsDropdown)

                        Library:Notification({
                            Name = "Success",
                            Description = "Succesfully created config: ".. ConfigName,
                            Color = Color3.fromRGB(0, 255, 0),
                            Duration = 5
                        })
                    end
                    ...
                    if ConfigSelected then 
                        if isfile(Library:GetFolder().. ConfigSelected .. ".json") then
                            delfile(Library:GetFolder().. ConfigSelected .. ".json")
                            Library:RefreshConfigsList(ConfigsDropdown)

                            Library:Notification({
                                Name = "Success",
                                Description = "Succesfully deleted config: ".. ConfigSelected,
                                Color = Color3.fromRGB(0, 255, 0),
                                Duration = 5
                            })
                        end
                ...
                ConfigsSection:Button():Add("Load", function()
                    if ConfigSelected then 
                        if isfile(Library:GetFolder().. ConfigSelected .. ".json") then
                            local ConfigContent = readfile(Library:GetFolder().. ConfigSelected .. ".json")
                            local Success, Error = Library:LoadConfig(ConfigContent)
                            ...
                            if Success then 
                                ...
                                Library:Notification({
                                    Name = "Error",
                                    Description = "Failed to load config: ".. (ConfigSelected or "Unknown") .. "\n" .. (Error or "Unknown error"),
                                    Color = Color3.fromRGB(255, 0, 0),
                                    Duration = 5
                                })
                            end
                            ...
                            Library:Notification({
                                Name = "Error",
                                Description = "Failed to find config: ".. ConfigSelected,
                                Color = Color3.fromRGB(255, 0, 0),
                                Duration = 5
                            })
                        end
                    ...
                    if ConfigSelected then
                        if isfile(Library:GetFolder().. ConfigSelected .. ".json") then
                            local Success, Error = pcall(function()
                                writefile(Library:GetFolder().. ConfigSelected .. ".json", Library:GetConfig())
                            end)
                            
                            if Success then 
                                Library:Notification({
                                    Name = "Success",
                                    Description = "Succesfully saved config: ".. ConfigSelected,
                                    Color = Color3.fromRGB(0, 255, 0),
                                    Duration = 5
                                })
                            else
                                Library:Notification({
                                    Name = "Error",
                                    Description = "Failed to save config: ".. ConfigSelected .. "\n" .. Error,
                                    Color = Color3.fromRGB(255, 0, 0),
                                    Duration = 5
                                })
                            end
                ...
                ConfigsSection:Button():Add("Refresh", function()
                    Library:RefreshConfigsList(ConfigsDropdown)
                end)

                ConfigsSection:Button():Add("Set Autoload", function()
                    if ConfigSelected and isfile(Library:GetFolder().. ConfigSelected .. ".json") then
                        local ConfigContent = readfile(Library:GetFolder().. ConfigSelected .. ".json")
                        writefile(Library.Folders.Directory .. "/autoload.json", ConfigContent)

                        Library:Notification({
                            Name = "Success",
                            Description = "Succesfully set autoload to: ".. ConfigSelected,
                            Color = Color3.fromRGB(0, 255, 0),
                            Duration = 5
                        })
                    end
                ...
                local PastedConfig = ""
                local SharedConfigTextbox = ConfigsSection:Textbox({
                    Name = "Paste shared config",
                    Description = "Paste a shared config here",
                    Flag = "SharedConfigPaste",
                ...
                ConfigsSection:Button():Add("Share Config", function()
                    ...
                    if PastedConfig and PastedConfig ~= "" then
        ...
        do
            ...
            local ThemingConfigs = SettingsPage:Section({Name = "Theme Configs", Side = 1})
            local ThemeColorpickers = { }

            do
                for Index, Value in Library.Theme do 
                    ThemeColorpickers[Index] = ThemingSection:Label(Index, Index:lower() .. " theme color"):Colorpicker({
            ...
            do
                ...
                local ThemesDropdown = ThemingConfigs:Dropdown({
                    Name = "Themes",
                    Flag = "ThemesDropdown",
                ...
                ThemingConfigs:Button():Add("Create", function()
                    if ThemeName then 
                        if ThemeName == "" then 
                            return
                        end

                        writefile(Library:GetFolderTheme().. ThemeName .. ".json", Library:GetTheme())
                        Library:RefreshThemeList(ThemesDropdown)

                        Library:Notification({
                            Name = "Success",
                            Description = "Succesfully created theme: ".. ThemeName,
                            Color = Color3.fromRGB(0, 255, 0),
                            Duration = 5
                        })
                    end
                    ...
                    if ThemeSelected then 
                        if isfile(Library:GetFolderTheme().. ThemeSelected .. ".json") then
                            delfile(Library:GetFolderTheme().. ThemeSelected .. ".json")
                            Library:RefreshThemeList(ThemesDropdown)

                            Library:Notification({
                                Name = "Success",
                                Description = "Succesfully deleted theme: ".. ThemeSelected,
                                Color = Color3.fromRGB(0, 255, 0),
                                Duration = 5
                            })
                        end
                ...
                ThemingConfigs:Button():Add("Load", function()
                    if ThemeSelected then 
                        if isfile(Library:GetFolderTheme().. ThemeSelected .. ".json") then
                            local ThemeContent = readfile(Library:GetFolderTheme().. ThemeSelected .. ".json")
                            ...
                            if Success then 
                                ...
                                Library:Notification({
                                    Name = "Error",
                                    Description = "Failed to load theme: ".. ThemeSelected .. "\n" .. Error,
                                    Color = Color3.fromRGB(255, 0, 0),
                                    Duration = 5
                                })
                            end
                            ...
                            Library:Notification({
                                Name = "Error",
                                Description = "Failed to find theme: ".. ThemeSelected,
                                Color = Color3.fromRGB(255, 0, 0),
                                Duration = 5
                            })
                        end
                    ...
                    if ThemeSelected then
                        if isfile(Library:GetFolderTheme().. ThemeSelected .. ".json") then
                            local Success, Error = pcall(function()
                                writefile(Library:GetFolderTheme().. ThemeSelected .. ".json", Library:GetTheme())
                            end)
                            
                            if Success then 
                                Library:Notification({
                                    Name = "Success",
                                    Description = "Succesfully saved theme: ".. ThemeSelected,
                                    Color = Color3.fromRGB(0, 255, 0),
                                    Duration = 5
                                })
                            else
                                Library:Notification({
                                    Name = "Error",
                                    Description = "Failed to save theme: ".. ThemeSelected .. "\n" .. Error,
                                    Color = Color3.fromRGB(255, 0, 0),
                                    Duration = 5
                                })
                            end
                ...
                ThemingConfigs:Button():Add("Refresh", function()
                    Library:RefreshThemeList(ThemesDropdown)
                end)

                local PresetThemes = ThemingConfigs:Dropdown({
                    Name = "Themes Preset", 
                    ...
                    Callback = function(Value)
                        ...
                        for Index, Value in Library.Theme do 
                            ...
                            ThemeColorpickers[Index]:Set(ThemeData[Index])
                        end
                    end
                })

                for Index, Value in Library.Themes do 
                    PresetThemes:Add(Index)
                end
        ...
        do
            ...
            do
                ...
                SettingsSection:Label("Menu keybind", "Keybind to open/close the menu"):Keybind({
                    Name = "Menu keybind",
                    Flag = "Menu Keybind",
                ...
                SettingsSection:Slider({
                    ...
                    Description = "Menu background opacity",
                    Min = 0,
                    Max = 1,
                ...
                SettingsSection:Slider({
                    Name = "Tween time",
                    Description = "Menu animation speed",
                    Min = 0,
                    Max = 5,
                ...
                SettingsSection:Dropdown({
                    Name = "Style",
                    Description = "Menu animation style",
                    Flag = "TweenStyle",
                    Default = "Cubic",
                ...
                SettingsSection:Dropdown({
                    Name = "Direction",
                    Description = "Menu animation direction",
                    Flag = "TweenDirection",
                    Default = "Out",
                    Items = {"In", "Out", "InOut"},
                    Callback = function(Value)
                ...
                SettingsSection:Toggle({
                    Name = "KeybindList",
                    Flag = "KeybindList",
                    Description = "List of all the keybinds",
                    Default = false,
                    Callback = function(Value)
                ...
                SettingsSection:Toggle({
                    Name = "Custom Cursor",
                    Flag = "Custom Cursor",
                    Description = "Custom cursor for the menu",
                    Default = true,
                    Callback = function(Value)
                ...
                SettingsSection:Toggle({
                    Name = "Auto Save",
                    Flag = "Auto Save",
                    Description = "Auto saves your config",
                    Default = false,
                    Callback = function(Value)
